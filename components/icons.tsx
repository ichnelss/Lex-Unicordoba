...
export const WandIcon: React.FC<{ className?: string }> = ({ className }) => (
 <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
  <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c.251.023.501.05.75.082m.75.082a24.301 24.301 0 014.5 0m4.5 0a24.301 24.301 0 014.5 0m-16.5 0a24.301 24.301 0 014.5 0m4.5 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M21 19.5a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 19.5m18 0v-2.25a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 15m18 0V5.197a2.25 2.25 0 00-2.25-2.25H5.25A2.25 2.25 0 003 5.197v4.606m18 0c0 .597-.237 1.17-.659 1.591L14.25 14.5l-5.051-.836" />
 </svg>
);
